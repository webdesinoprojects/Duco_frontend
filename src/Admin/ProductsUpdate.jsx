            ...
            {formData.image_url.map((img, imgIndex) => (
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  <button
                    type="button"
                    onClick={() => addDesignField(imgIndex)}
                    className="text-blue-500 text-sm"
                  >
                    + Add Design
                  </button>
            ...
            <div className="bg-gray-50 p-4 rounded space-y-3 text-sm">
              ...
              {formData.image_url.map((img, i) => (
                <div key={i} className="ml-4">
                  <p>
                    🎨 <strong>Color:</strong> {img.color} ({img.colorcode})
                  </p>
                  {img.url.map((url, j) => (
                  ...
                  {img.content.map((c, k) => (
                    <p key={k} className="ml-6">
                      👕 Size: {c.size}, Stock: {c.minstock}
                    </p>
                  ))}
              ...
              {formData.pricing.map((p, i) => (
                <p key={i}>
                  Qty: {p.quantity}, Price: ₹{p.price_per}, Discount:{" "}
                  {p.discount}%
                </p>
              ))}
              <p>
