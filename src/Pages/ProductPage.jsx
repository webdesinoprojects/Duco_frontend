  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      if (data) {
        ...
        setPrice(calculated); // 👈 already rounded in calculatePrice function
      }
      // Remove the redirect - let users stay on product page even if price context is loading
    };
    fetchProduct();
  }, [id]);
